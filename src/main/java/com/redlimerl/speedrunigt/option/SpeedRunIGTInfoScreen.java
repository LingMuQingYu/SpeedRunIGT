...
public class SpeedRunIGTInfoScreen extends Screen {
    ...
    protected void init() {
        ...
        update.active = false;
        addButton(new ButtonWidget(width / 2 + 5, height - 104, 150, 20, I18n.translate("speedrunigt.menu.latest_change_log"), (ButtonWidget button) -> Util.getOperatingSystem().open("https://github.com/RedLime/SpeedRunIGT/releases")));
