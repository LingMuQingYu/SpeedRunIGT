...
public class TimerCustomizeScreen extends Screen {
    ...
    protected void init() {
        ...
        addButton(new ButtonWidget(width / 2 - 60, height / 2 - 48, 120, 20, new TranslatableText("speedrunigt.option.timer_position."+ (page == 0 ? "color_mode" : "position_mode")), (ButtonWidget button) -> {
            if (page == 0) page = 1;
            else page = 0;
    ...
    public void initNormal() {
        normalOptions.add(
                addButton(new SliderWidget(width / 2 - 127, height / 2 - 26, 120, 20, new TranslatableText("speedrunigt.option.timer_position.scale", "IGT").append(" : ").append(((int) (drawer.getIGTScale() * 100)) + "%"), (drawer.getIGTScale() - 0.5f) / 2.5f) {
                    @Override
        ...
        normalOptions.add(
                addButton(new SliderWidget(width / 2 + 6, height / 2 - 26, 120, 20, new TranslatableText("speedrunigt.option.timer_position.scale", "RTA").append(" : ").append(((int) (drawer.getRTAScale() * 100)) + "%"), (drawer.getRTAScale() - 0.5f) / 2.5f) {
                    @Override
                    protected void updateMessage() {
        ...
        normalOptions.add(
                addButton(new SliderWidget(width / 2 - 60, height / 2 - 4, 120, 20, new TranslatableText("speedrunigt.option.timer_position.background_opacity").append(" : ").append(((int) (drawer.getBackgroundOpacity() * 100)) + "%"), drawer.getBackgroundOpacity()) {
                    @Override
                    protected void updateMessage() {
        ...
        normalOptions.add(
                addButton(new ButtonWidget(width / 2 - 60, height / 2 + 18, 120, 20, new TranslatableText("speedrunigt.option.timer_position.top_timer").append(" : ").append(drawer.isReversedOrder() ?  "RTA" : "IGT"), (ButtonWidget button) -> {
        ...
        normalOptions.add(
                addButton(new ButtonWidget(width / 2 - 60, height / 2 + 40, 120, 20, new TranslatableText("speedrunigt.option.timer_position.show_time_only").append(" : ").append(drawer.isSimplyTimer() ? ScreenTexts.ON : ScreenTexts.OFF), (ButtonWidget button) -> {
    ...
    public void initColor() {
        colorOptions.add(
                addButton(new SliderWidget(width / 2 - 127, height / 2 - 26, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_red", "IGT").append(" : ").append(String.valueOf(ColorMixer.getRed(drawer.getIGTColor()))), ColorMixer.getRed(drawer.getIGTColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
        ...
        colorOptions.add(
                addButton(new SliderWidget(width / 2 - 127, height / 2 - 4, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_green", "IGT").append(" : ").append(String.valueOf(ColorMixer.getGreen(drawer.getIGTColor()))), ColorMixer.getGreen(drawer.getIGTColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
        ...
        colorOptions.add(
                addButton(new SliderWidget(width / 2 - 127, height / 2 + 18, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_blue", "IGT").append(" : ").append(String.valueOf(ColorMixer.getBlue(drawer.getIGTColor()))), ColorMixer.getBlue(drawer.getIGTColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
        ...
        colorOptions.add(
                addButton(new SliderWidget(width / 2 + 6, height / 2 - 26, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_red", "RTA").append(" : ").append(String.valueOf(ColorMixer.getRed(drawer.getRTAColor()))), ColorMixer.getRed(drawer.getRTAColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
        ...
        colorOptions.add(
                addButton(new SliderWidget(width / 2 + 6, height / 2 - 4, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_green", "RTA").append(" : ").append(String.valueOf(ColorMixer.getGreen(drawer.getRTAColor()))), ColorMixer.getGreen(drawer.getRTAColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
        ...
        colorOptions.add(
                addButton(new SliderWidget(width / 2 + 6, height / 2 + 18, 120, 20, new TranslatableText("speedrunigt.option.timer_position.color_blue", "RTA").append(" : ").append(String.valueOf(ColorMixer.getBlue(drawer.getRTAColor()))), ColorMixer.getBlue(drawer.getRTAColor()) / 255.0f) {
                    @Override
                    protected void updateMessage() {
        ...
        colorOptions.add(
                addButton(new ButtonWidget(width / 2 + 6, height / 2 + 40, 120, 20, new TranslatableText("speedrunigt.option.timer_position.text_outline", "RTA").append(" : ").append(drawer.isRTADrawOutline() ? ScreenTexts.ON : ScreenTexts.OFF), (ButtonWidget button) -> {
        ...
        colorOptions.add(
                addButton(new ButtonWidget(width / 2 - 127, height / 2 + 40, 120, 20, new TranslatableText("speedrunigt.option.timer_position.text_outline", "IGT").append(" : ").append(drawer.isIGTDrawOutline() ? ScreenTexts.ON : ScreenTexts.OFF), (ButtonWidget button) -> {
