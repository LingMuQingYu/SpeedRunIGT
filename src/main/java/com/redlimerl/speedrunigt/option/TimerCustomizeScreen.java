...
public class TimerCustomizeScreen extends Screen {
    ...
    protected void init() {
        ...
        this.normalButton = addButton(new ButtonWidget(width / 2 - 120, height / 2 - 48, 58, 20, new TranslatableText("options.title").append("..."), (ButtonWidget button) -> {
        ...
        this.igtButton = addButton(new ButtonWidget(width / 2 - 60, height / 2 - 48, 58, 20, new LiteralText("IGT..."), (ButtonWidget button) -> {
        ...
        this.rtaButton = addButton(new ButtonWidget(width / 2, height / 2 - 48, 58, 20, new LiteralText("RTA..."), (ButtonWidget button) -> {
            this.normalButton.active = true;
            this.igtButton.active = true;
        ...
        this.fontButton = addButton(new ButtonWidget(width / 2 + 60, height / 2 - 48, 58, 20, new TranslatableText("speedrunigt.title.font"), (ButtonWidget button) -> {
            this.normalButton.active = true;
            this.igtButton.active = true;
            this.rtaButton.active = true;
